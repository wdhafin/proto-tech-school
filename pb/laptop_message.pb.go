...
type Laptop struct {
	...
	PriceUsb    float64                `protobuf:"fixed64,12,opt,name=price_usb,json=priceUsb,proto3" json:"price_usb,omitempty"`
...
func (x *Laptop) GetPriceUsb() float64 {
	if x != nil {
		return x.PriceUsb
	}
	return 0
...
var file_laptop_message_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x5f, 0x75, 0x73, 0x62, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x01, 0x52, 0x08, 0x70, 0x72,
	0x69, 0x63, 0x65, 0x55, 0x73, 0x62, 0x12, 0x21, 0x0a, 0x0c, 0x72, 0x65, 0x6c, 0x65, 0x61, 0x73,
